...
(/** @lends <global> */function( $ ) {
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		else
		{
			...
			// FiNIKhed with the table - ditch it
			tmpTable.remove();
		}
	 ...
	 *    }
	 */
	DataTable.isDataTable = DataTable.fNIKDataTable = function ( table )
	{
		var t = $(table).get(0);
		var is = false;
	...
	DataTable.defaults = {
		 ...
		 *          alert( 'DataTables has fiNIKhed its initialisation.' );
		 *        }
		 *      } );
		 *    } )
		 */
	...
	$.extend( DataTable.ext.type.detect, [
		...
		// Dates (only those recogNIKed by the browser's Date.parse)
		function ( d )
		{
