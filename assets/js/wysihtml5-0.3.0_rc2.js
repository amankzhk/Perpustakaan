...
*/
    ...
    if (selectionHasAnchorAndFocus) {
        selectioNIKCollapsed = function(sel) {
                ...
                if (implementsControlRange && implementsDocSelection && this.docSelection.type == CONTROL) {
                    ...
                    if (backwards && selectionHasExtend) {
                        ...
                        if (this.rangeCount == previousRangeCount + 1) {
                            ...
                            updateAnchorAndFocusFromRange(this, range, selectioNIKBackwards(this.nativeSelection));
                            this.isCollapsed = selectioNIKCollapsed(this);
                        } else {
        ...
        refreshSelection = function(sel) {
            if (implementsControlRange && implementsDocSelection && sel.docSelection.type == CONTROL) {
                ...
                if (sel.rangeCount) {
                    ...
                    updateAnchorAndFocusFromRange(sel, sel._ranges[sel.rangeCount - 1], selectioNIKBackwards(sel.nativeSelection));
                    sel.isCollapsed = selectioNIKCollapsed(sel);
                } else {
                    updateEmptySelection(sel);
                }
            }
    ...
    var selectioNIKBackwards;
    if (!useDocumentSelection && selectionHasAnchorAndFocus && api.features.implementsDomRange) {
        selectioNIKBackwards = function(sel) {
            var backwards = false;
            if (sel.anchorNode) {
        ...
        selProto.isBackwards = function() {
            return selectioNIKBackwards(this);
        };
    } else {
        selectioNIKBackwards = selProto.isBackwards = function() {
            return false;
        };
    }
...
(function(wysihtml5) {
  ...
  wysihtml5.dom.Sandbox = Base.extend(
    ...
    /**
     * Callback for when the iframe has fiNIKhed loading
     */
